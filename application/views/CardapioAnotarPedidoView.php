                      ...
                      <div id="<?php echo $cat->descricao;?>" idCategoria = "<?php echo $cat->id;?>" class="container tab-pane <?php if($x==0){echo "active";}else{echo "fade";}?>">
                        ...
                        <button class="btn btn-primary btn-sm my-2" data-toggle="modal" data-target="#meiaPizza">
                          2-SABORES
                                    ...
                                    <label tamanho="Media" class="btn btn-secondary btn-sm active">
                                    <input type="radio"  name="options" id="option1" autocomplete="off" checked>
                                      Média
                                    </label>
                                    <label tamanho="Grande" class="btn btn-sm btn-secondary">
                                    <input type="radio" name="options"  id="option2" autocomplete="off">
                                      Grande
                                    </label>
                                    <label  tamanho="Familia" class="btn btn-sm btn-secondary">
                        ...
                        <?php } ?>
                        <table class="table table-bordered my-2" id="<?php if($cat->id == 1){ echo "cardapioPizza"; }?>">
