<div id="topo" class="col-12 row">	
			...
			<div class="collapse navbar-collapse col-10" id="navbarSite" style="bo rder:1px solid red;">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item"><a href="<?php echo base_url();?>" class="nav-link r">Home</a></li>
					<li class="nav-item"><a href="<?php echo base_url();?>" class="nav-link ">Perfil</a></li>
					<li class="nav-item"><a href="<?php echo base_url();?>" class="nav-link ">Serviços</a></li>
